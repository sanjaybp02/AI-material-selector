...
from modules.ui import (
    ...
    inject_clarity, render_stl_viewer, render_stepper, scroll_to_anchor,
)
...
def render_advanced_results(processed, rec_names, df_display, unit_system, api_key, model_name):
    ...
    # stays visible no matter which tab — Charts, Compare, CAD Studio,
    # History — is active, instead of disappearing the moment you look at
    # a chart.
